...
The system recommends Restock quantities based on a sophisticated heuristic (found in `StockOrdering.tsx`):
...
5.  **Capacity Constraint:** Calculates "True Free Space" in configured Deep Freezers (Litres).
6.  **Allocation:** Distributes free space to SKUs proportional to their Weighted Demand.
